    ...
    >
      <div className={`max-w-6xl mx-auto ${isInView ? 'revealed' : ''}`}>
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16 space-y-3 sm:space-y-4 reveal-up">
          ...
          <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground font-mono leading-tight">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-3xl mx-auto leading-normal px-4">
        ...
        <div className="mb-14 sm:mb-16 md:mb-20 reveal-up stagger-1">
          ...
          <p className="text-sm text-muted-foreground/80 leading-relaxed max-w-2xl mt-4 sm:mt-5 mb-5 sm:mb-6">
        ...
        <div className="mb-14 sm:mb-16 md:mb-20 reveal-up stagger-2">
          ...
          <div className="space-y-5 sm:space-y-6 mt-5 sm:mt-6">
            <div>
              <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Currently Playing</h4>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">All-Time Favorites</h4>
              <div className="flex flex-wrap gap-2">
                {favoriteGames.map((game) => (
                  <span
                    key={game}
                    className="px-3 py-1.5 rounded-full border border-border bg-secondary/30 text-foreground/90 text-sm font-medium cursor-default"
                  >
                    {game}
                  </span>
                ))}
        ...
        <div className="mb-14 sm:mb-16 md:mb-20 reveal-up stagger-3">
          ...
          <div className="mt-5 sm:mt-6 space-y-6 sm:space-y-8">
            {/* Currently reading */}
            <div>
              <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Currently Reading</h4>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                {currentlyReading.map((item) => (
                  <div
                    ...
                    className="flex items-center justify-between gap-2 px-3 py-2.5 sm:px-4 sm:py-3 rounded-lg border border-border/50 bg-card/30"
                  >
                    <span className="text-sm font-semibold text-foreground break-words min-w-0">{item.title}</span>
                    <span className="text-[10px] sm:text-xs px-2 py-0.5 rounded-full bg-emerald/10 text-emerald border border-emerald/20 font-medium whitespace-nowrap flex-shrink-0">
                      {item.type}
                    </span>
                  </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Favorite Anime</h4>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Music</h4>
                <div className="flex flex-wrap gap-2">
        ...
        <div className="reveal-up stagger-4">
          ...
          <div className="mt-5 sm:mt-6 space-y-6 sm:space-y-8">
            <div>
              <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">PC Setup</h4>
              <SpecGrid specs={pcSpecs} />
            </div>

            <div>
              <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Proxmox Server</h4>
...
const SectionHeader = memo(({ icon: Icon, title }: { icon: React.ElementType; title: string }) => (
  <div className="flex items-center gap-3">
    ...
    <h3 className="text-sm md:text-base font-bold text-foreground font-mono leading-tight">{title}</h3>
  </div>
));
